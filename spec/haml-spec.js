...
(function() {
  ...
  describe('element generator', function() {
    ...
    it('should transform normal elements to createElements', function() {
      var exp, src, txt;
      txt = '%h1#ugh.huga.buga\n  .test\n    %p foo';
      exp = '<h1 id="ugh" class="huga buga"><div class="test"><p>      foo</p></div></h1>';
      src = haml.compileHaml({
        source: txt,
        generator: 'elementgenerator'
      });
      this.node.appendChild(src());
      return expect(this.node.innerHTML).toEqual(exp);
    });
    it('should work with eval with elements', function() {
      var div_node, exp, src, txt;
      txt = '.root\n  %p\n    = title';
    ...
    it('should work with eval with text', function() {
      var exp, src, txt;
      txt = '.root\n  %p\n    = title';
    ...
    it('should work with eval with condition', function() {
      var exp, src, txt;
      txt = '.root\n  %p\n    begin\n    - if (visible) {\n      = title\n    - } else {\n      zzzz\n    - }\n    last';
      ...
      expect(this.node.innerHTML).toEqual(exp);
    ...
    it('should work for dynamic types', function() {
      var exp, src, txt;
    ...
    return it('should work for tree struct', function() {
      var exp, src, txt;
