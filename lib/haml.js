...
(function() {
  var Buffer, CodeGenerator, CoffeeCodeGenerator, HamlRuntime, JsCodeGenerator, ProductionJsCodeGenerator, Tokeniser, filters, haml, root,
  ...
  haml = {
    ...
    _closeElements: function(indent, elementStack, tokeniser, generator) {
      ...
      results = [];
      while (i >= indent) {
        results.push(this._closeElement(i--, elementStack, tokeniser, generator));
      }
      return results;
    },
