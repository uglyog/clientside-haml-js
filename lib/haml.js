  ...
  */
  ...
  JsCodeGenerator = (function() {
    ...
    */
    ...
    JsCodeGenerator.prototype.appendTextContents = function(text, shouldInterpolate) {
  ...
  */
  ...
  CoffeeCodeGenerator = (function() {
    ...
    */
    ...
    CoffeeCodeGenerator.prototype.appendTextContents = function(text, shouldInterpolate) {
      if (shouldInterpolate && text.match(/#{[^}]*}/)) {
        this.outputBuffer.flush();
