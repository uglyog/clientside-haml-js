  ...
  */
  ...
  root.haml = {
    ...
    */
    ...
    _filter: function(tokeniser, indent, generator, options) {
      ...
      if (tokeniser.token.filter) {
        ...
        if (!haml.filters[filter]) {
          this._handleError(options, indent, tokeniser, tokeniser.parseError("Filter '" + filter + "' not registered. Filter functions need to be added to 'haml.filters'."));
          return;
        }
    ...
    _handleError: function(options, indent, tokeniser, error) {
      if (options != null ? options.tolerateFaults : void 0) {
        console.log(error);
        return this._skipToNextLineWithIndent(tokeniser, indent);
      } else {
        throw error;
      }
    },
