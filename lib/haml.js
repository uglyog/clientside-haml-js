...
(function() {
  var Buffer, CodeGenerator, CoffeeCodeGenerator, ElementGenerator, HamlRuntime, JsCodeGenerator, ProductionJsCodeGenerator, Tokeniser, filters, haml, root, _ref,
  ...
  */
  ...
  CodeGenerator = (function() {
    ...
    CodeGenerator.prototype.closeElements = function(indent, elementStack, tokeniser, generator) {
      ...
      _results = [];
      while (i >= indent) {
        _results.push(this.closeElement(i--, elementStack, tokeniser, generator));
      }
      return _results;
    };
  ...
  */
  ...
  ElementGenerator = (function(_super) {
    __extends(ElementGenerator, _super);

    function ElementGenerator(options) {
      this.options = options;
      this.outputBuffer = new haml.Buffer(this);
    }
